...
const userDetail = async function (req,res){
  ...
  let newData = await userModel.findById(userId)
  console.log(newData)
...
const updateUser = async (req,res)=>{
  ...
  let newUpdation = await userModel.findByIdAndUpdate({_id:userId },userData , {new: true})
  console.log(newUpdation)
  if(!newUpdation){return res.send({status:false , msg:"user id does  not exist"})}
  res.send({status:true, msg: newUpdation})
}
